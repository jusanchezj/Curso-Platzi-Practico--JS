...
// declarar:
name= "juan"
// con let yo puedo cambiar el nombre, con const no, me saldria un error
...
```
function imprimirElementoPorElementoObjeto(obj) {          //Object.values() para pasar de un objeto a array, muy util
